...
function Footer() {
  return (
    <div className="flex gap-5 w-full h-screen bg-zinc-900 py-5 px-5">
      <div className="w-1/2 h-full flex flex-col justify-between font-['Founders_Grotesk_X-Condensed']">
        <div className="heading">
          <h1 className="text-[8vw] uppercase leading-none -mb-7 font-semibold">
            Eye-
          </h1>
          <h1 className="text-[8vw] uppercase leading-none -mb-7 font-semibold">
            Opening
      ...
      <div className="w-1/2">
        <h1 className="text-[8vw] font-['Founders_Grotesk_X-Condensed'] uppercase leading-none -mb-7 font-semibold">
          Presentations
          
        </h1>
        <div className="dets font-['Neue-Montreal'] mt-10">
            {["Facebook", "Instagram", "Twitter", "Gmail"].map(
              (item, index) => (
                <a className="block text-xl font-light " key={index} href="#">
                  {item}
                </a>
              )
            )}
